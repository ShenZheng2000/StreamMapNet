...
# bash tools/dist_train.sh plugin/configs/mapchange_geosplit_608_60x30_30e.py 8
# bash tools/dist_train.sh plugin/configs/mapchange_608_60x30_30e.py 8
...
# bash tools/dist_test.sh plugin/configs/mapchange_geosplit_608_60x30_30e.py work_dirs/mapchange_geosplit_608_60x30_30e/latest.pth 8 --eval